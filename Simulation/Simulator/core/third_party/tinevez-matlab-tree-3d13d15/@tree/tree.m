...
% Jean-Yves Tinevez <tinevez@pasteur.fr> March 2012
    ...
    properties (SetAccess = private)
        ...
        % Added by Mohamed Mustafa, August 2020
        label_to_id_map = containers.Map('KeyType','char','ValueType','double');   % hash table to map label (if exists) to ID
    end
    ...
    methods
        ...
        function [obj, ID] = addnode(obj, parent, data)
            ...
            % Added by Mohamed Mustafa, August 2020
            try
                obj.label_to_id_map(data.label) = ID;
            catch
                obj.label_to_id_map(num2str(ID)) = ID;
            end
        end
