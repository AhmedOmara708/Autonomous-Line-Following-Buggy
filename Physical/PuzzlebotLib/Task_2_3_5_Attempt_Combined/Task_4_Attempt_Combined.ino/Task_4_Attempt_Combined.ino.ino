...
int ReflectanceSensor[11] = {23,1,21,13,26,33,22,3,19,27,25,32}; 
...
Encoder Enc (encoderR_pinA, encoderR_pinB, gear_ratio_r, encoderL_pinA, encoderL_pinB, encoderR_ticks, wheel_radius_r, distance_between_wheels);
